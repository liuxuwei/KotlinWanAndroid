 ...
 * description
 */
class ProjectAndArticlePresenter(val context: Context): BasePresenter<ContractProjectAndArticle.ProjectAndArticleView>(),ContractProjectAndArticle.ProjectAndArticleModel {
